...
public class TaskController {
    ...
    @RequestMapping("/employees/addTasksToEmployee/{employeeId}")
    ...
    @RequestMapping(value = "/employees/{employeeId}/assignTaskToEmployee/{taskId}")
    public String assignTaskToEmployee(@PathVariable("taskId") Integer taskId,
    ...
    @RequestMapping(value = "/employees/{employeeId}/unassignTaskFromEmployee/{taskId}")
    ...
    @RequestMapping("projects/{projectId}/assignTaskToProject/{taskId}")
    ...
    @RequestMapping("projects/{projectId}/unassignTaskFromProject/{taskId}")
    ...
    @RequestMapping(value = "/employee/doneTask/{employeeId}/{taskId}")
    ...
    @RequestMapping("tasks/taskForm")
    public ModelAndView createTask() {
        return new ModelAndView("forms/taskForm","task", new Task());
    }

    @RequestMapping(value = "tasks/saveTask", method = RequestMethod.POST)
